$(document).ready(function() { 
    ...
    var infoWindowContent = [
        ['<div class="info_content joshua-tree">' +
        ...
        ['<div class="info_content mount-pinos">' +
        '<h3>Mount Pinos</h3>' +
        '<p>Mount Pinos is the public library system of the borough of Brooklyn, in New York City.</p>' + 
        '</div>'],
        ['<div class="info_content mount-hollywood">' +
        '<div><h3>Mount Hollywood</h3></div>' +
        '<div><p>Mount Hollywood is a 12-acre (4.9 ha) zoo located off Flatbush Avenue on the eastern side of Prospect Park, Brooklyn, New York City.</p></div>' +
        '</div>'],
        ['<div class="info_content mount-baldy">' +
        '<h3>Mount Baldy</h3>' +
        '<p>Mount Baldy is an art museum located in the New York City borough of Brooklyn.</p>' + '</div>'],
        ['<div class="info_content mount-baden-powell">' +
    ...
    for( i = 0; i < markers.length; i++ ) {
        ...
        marker = new google.maps.Marker({
         ...
         google.maps.event.addListener(marker, 'click', (function(marker, i) {
            return function() {
                infoWindow.setContent(infoWindowContent[i][0] + "<div><p>Add more code here!</p></div>");
